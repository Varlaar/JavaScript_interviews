...
*У нас есть функция-конструктор `Person`:*
...
<br>**Классы** - это всего лишь синтаксический сахар, появившийся в JavaScript в новых стандартах ECMAScript 2015 и обеспечивающий удобный способ создания конструкторов и наследования.<br>
...
*Создадим объект `animal` и объект `rabbit`:*
```js
const animal = {
  name: "animal",
  hasTail: true,
...
<br> **Важно:** использование  `Object.setPrototypeOf()` не рекомендуется из-за негативного влияния на производительность.
